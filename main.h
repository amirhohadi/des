//
// Created by amirhossein on 12/12/20.
//
#ifndef DES_MAIN_H
#define DES_MAIN_H
struct block{
...
uint64_t permutate(uint64_t data,const int* mask,int from,int to);
...
const char man[] = "des encryption/decryption app\n"
                   "version = 1.0\n"
                   "author : amir hossein ohadi\n"
                   "args : \n"
                   "-g <file_name> generate key into file\n"
                   "-e <input_file> <key_file> <output_file> Encrypt input data\n"
                   "-d <input_file> <key_file> <output_file> Decrypt input data\n";
